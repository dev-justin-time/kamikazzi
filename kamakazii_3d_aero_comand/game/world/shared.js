...
function withTimeout(promise, ms) {
  ...
  const timeout = new Promise((_, reject) => {
    timer = setTimeout(() => reject(new Error(`Asset load timed out after ${ms}ms`)), ms);
  });
...
// Crash splash image now generated by crash-assets.js getCrashSplashUrl().
// Set dynamically in modals.js startExplodeSequence().
