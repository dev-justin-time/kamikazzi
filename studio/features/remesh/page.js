/**
 * Remesh — Remesh, decimate, retopology — reduce or rebuild geometry topology
 */
...
const meta = {
  controls: [
    { key: 'target-count', type: 'number', label: 'Target Vertices', default: 1000 },
    { key: 'preserve-edges', type: 'toggle', label: 'Preserve Edges', default: true },
    { key: 'method', type: 'select', label: 'Method', default: '', options: [{"value":"uniform","label":"Uniform"},{"value":"adaptive","label":"Adaptive"},{"value":"quadric","label":"Quadric Error"}] },
    { key: 'sep1', type: 'label', label: '──────────' },
    { key: 'apply-remesh', type: 'button', label: 'Apply Remesh', onClick: 'logRemesh' },
    { key: 'apply-decimate', type: 'button', label: 'Decimate 50%', onClick: 'logDecimate' }
  ],
  onApply: () => {},
};
